...
const YOUStaking = artifacts.require("./YOU/YOUStaking.sol")
const YOUToken = artifacts.require("./YOU/YOUToken.sol")
const CommunityIssuance = artifacts.require("./YOU/CommunityIssuance.sol")
const HintHelpers = artifacts.require("./HintHelpers.sol")

const CommunityIssuanceTester = artifacts.require("./YOU/CommunityIssuanceTester.sol")
...
const YOUContractABIs = [YOUStaking, YOUToken, CommunityIssuance]
...
async function main() {
	...
	console.log(`\n`)
	console.log(`YOU CONTRACTS`)
	await logContractDeploymentCosts(YOUContracts)
	console.log(`\n`)
	logContractBytecodeLengths(YOUContractABIs)
	console.log(`\n`)
