...
async function main() {
  ...
  */
	...
	th.logBN("Initial U", USDV_balance)
	...
	// Approve U
	const U = new ethers.Contract(U, ERC20.abi, deployerWallet)
	const txApproveUSDV = await U.approve(VAULT, USDV_balance)
	const approveUSDVReceipt = await txApproveUSDV.wait()
	console.log("Approve U gas: ", approveUSDVReceipt.gasUsed.toString())
	...
	console.log(
		...
		receipt1.gasUsed
			...
			.add(approveUSDVReceipt.gasUsed)
