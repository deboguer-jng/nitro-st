async function main() {
	...
	const DefaultPoolFactory = await ethers.getContractFactory(
		"DefaultPool",
		this.deployerWallet
	)
	...
	const YOUStakingFactory = await ethers.getContractFactory("YOUStaking", this.deployerWallet)
	const BorrowerOperationsFactory = await ethers.getContractFactory(
		"BorrowerOperations",
		this.deployerWallet
	)
	const CollSurplusPoolFactory = await ethers.getContractFactory(
		"CollSurplusPool",
		this.deployerWallet
	)
	...
	console.log("YOU Staking", (await YOUStakingFactory.deploy()).address)
